...
st.title("Predviđanje Odliva Korisnika - Customer Churn Prediction")
...
st.write(f'Churn Probability: {predvidjanje_vjerovatnoce:.2f}')
...
#Bila su 2 Problema: -Previdio sam pisanje koda i izostavio "_" posle "...categories"
                #    -Nisam Dobro Upisao Imena Dvije Osobine iz DataSeta-, bolje receno, treniranog modela, na što je ukazivano displejom pogreske
